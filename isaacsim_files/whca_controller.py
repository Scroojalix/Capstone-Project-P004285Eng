...
# Find current working directory of this file
HERE = os.path.dirname(os.path.abspath(__file__))

# YAML file for occupancy map, as generated in Isaac Sim
MAP_YAML = os.path.join(HERE, "IsaacWarehouseOccupancyMapYAML.yaml")

# m per planning cell; must exceed the robot footprint
# TODO: this is actually just cell size
PLANNING_CELL = 1.0
