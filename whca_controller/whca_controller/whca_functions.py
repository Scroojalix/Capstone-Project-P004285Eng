...
def plan_window(start_positions, goal_positions, grid, window_size, arrived_flags,
                ...
                avoid_move_cycles=False) -> list[list[State]]:
    ...
    limit, unresolved agents receive incrementally extended initial waits; other
    paths are rebuilt around them before any committed steps are returned.
